...
ssh root@213.233.184.100 'echo deadline | tee /sys/block/vdb/queue/scheduler'
ssh root@213.233.184.100 'echo 0 | tee /sys/block/vdb/queue/iosched/front_merges'
ssh root@213.233.184.100 'echo 120 | tee /sys/block/vdb/queue/iosched/read_expire'
ssh root@213.233.184.100 'echo 1200 | tee /sys/block/vdb/queue/iosched/write_expire'
